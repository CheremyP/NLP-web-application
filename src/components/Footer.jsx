...
import koala_logo from '/src/assets/koala_black.png';

function Footer() {
  return (
    <footer className="text-gray-600 body-font">
    <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-s0 md:mx-0 mx-auto text-center md:text-left">
        <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
        <img src={koala_logo} alt="Logo" width="40px"  height="auto"/>
            <span className="ml-3 text-xl">Linguify</span>
        </a>
        <p className="mt-2 text-sm text-gray-500">Say goodbye to language barriers and hello to a world of communication with our audio translation app</p>
        </div>
        ...
        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <li>
                <a className="text-gray-600 hover:text-gray-800">Account settings</a>
            </li>
            <li>
                <a className="text-gray-600 hover:text-gray-800">Prefrences</a>
            </li>
            </nav>
        </div>
        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <li>
                <a className="text-gray-600 hover:text-gray-800">Frequently Asked Questions (FAQs)</a>
            </li>
            <li>
        ...
        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <li>
                <a className="text-gray-600 hover:text-gray-800">Privacy Policiy</a>
            </li>
            <li>
    ...
    <div className="bg-gray-100">
        ...
        <p className="text-gray-500 text-sm text-center sm:text-left">© 2023 Cheremy Pongajow - All rights reserved
        </p>
